...
import {
  FingerprintPopOptionsType,
  FingerprintConfigType,
  EnterPasswordConfigType,
} from './interface'
...
export class Toast {
  ...
  static loading(
    ...
    RootView.setView(
      <LoadingView text={text} time={time} onDismiss={this.hide} />,
    )
  }
}
...
export class Modal {
  ...
  static enterPassword(
    ...
    configer?: EnterPasswordConfigType,
  ) {
    RootView.setView(
      <EnterPassword
        hasCancel={configer ? configer.hasCancel : false}
        onClose={Modal.hide}
        onConfirm={onConfirm}
      />,
    )
  ...
  static FingerprintPopShow(
    fingerprintConfig: FingerprintConfigType,
    options: FingerprintPopOptionsType,
  ) {
    RootView.setView(
      <FingerprintPop
